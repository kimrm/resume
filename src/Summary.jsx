  ...
  return (
    <section className="container mx-auto my-10 p-2 md:p-0">
      ...
      <p className="rounded text-orange-950">
        ...
        stor interesse for utvikling av brukervennlige systemer og har konstant
        fokus på brukeropplevelsen. Jeg er alltid interessert i utfordringer som
        bidrar til personlig og faglig utvikling. Er lidenskapelig opptatt av{" "}
        <strong>Javascript,Typescript,Node.js og React</strong> og bruker mye av
        tiden min på å fordype meg i dette.
      </p>
    </section>
  );
}
